(function(){ 
    ...
    $('#grid-container').dxDataGrid({
        dataSource: '/administracion/slider/listar',
        ...
        columns: [
            ...
            },
            {
                ...
                hidingPriority: 0,
                cellTemplate(container, options) {
                    let html_editar = '<a href="/administracion/slider/editar/' + options.data.sli_id + '" class="edit" style="color: #DD5702; font-size: 20px; margin-right:10px;"><i class="fas fa-edit"></i></a>';
                    let html_eliminar = '<a class="eliminar" codigo="' + options.data.sli_id + '" style="color: #DD5702; font-size: 20px;"><i class="fas fa-trash"></i></a>';
...
$(document).on('click', '.eliminar', function () {
    ...
    alertify.confirm(popUp, function () {
        ...
        fetch('/administracion/slider/eliminar/'+codigo, {
            method: 'get',
        })
