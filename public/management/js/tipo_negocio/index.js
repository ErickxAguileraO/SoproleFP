(function(){ 
    ...
    $('#grid-container').dxDataGrid({
        dataSource: '/administracion/tipo-negocio/listar',
        ...
        columns: [
            ...
            {
                dataField: 'tne_nombre',
                caption: 'Nombre',
                allowEditing: false,
            },
            {
                dataField: 'tne_estado',
                caption: 'Estado',
                allowEditing: false,
                lookup: {
                    dataSource: {
            ...
            },
            {
                ...
                cellTemplate(container, options) {
                    let html_editar = '<a href="/administracion/tipo-negocio/editar/' + options.data.tne_id + '" class="edit" style="color: #DD5702; font-size: 20px; margin-right:10px;"><i class="fas fa-edit"></i></a>';
                    let html_eliminar = '<a class="eliminar" codigo="' + options.data.tne_id + '" style="color: #DD5702; font-size: 20px;"><i class="fas fa-trash"></i></a>';
...
$(document).on('click', '.eliminar', function () {
    ...
    alertify.confirm(popUp, function () {
        ...
        fetch('/administracion/tipo-negocio/eliminar/'+codigo, {
            method: 'get',
        })
