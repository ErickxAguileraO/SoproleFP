(function(){
    ...
    $('#grid-container').dxDataGrid({
        dataSource: '/administracion/menu/listar',
        ...
        columns: [
            ...
            },
            {
                ...
                cellTemplate(container, options) {
                    let html_editar = '<a href="/administracion/menu/editar/' + options.data.mdi_id + '" class="edit" style="color: #DD5702; font-size: 20px; margin-right:10px;"><i class="fas fa-edit"></i></a>';
                    return $(html_editar);
                }
            }],
    }).dxDataGrid('instance');
