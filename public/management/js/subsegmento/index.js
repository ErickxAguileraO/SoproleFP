(function(){ 
    ...
    $('#grid-container').dxDataGrid({
        dataSource: '/administracion/subsegmento/listar',
        ...
        columns: [
            ...
            },
            {
                ...
                cellTemplate(container, options) {
                    let html_editar = '<a href="/administracion/subsegmento/editar/' + options.data.sse_id + '" class="edit" style="color: #DD5702; font-size: 20px; margin-right:10px;"><i class="fas fa-edit"></i></a>';
                    let html_eliminar = '<a class="eliminar" codigo="' + options.data.sse_id + '" style="color: #DD5702; font-size: 20px;"><i class="fas fa-trash"></i></a>';
...
$(document).on('click', '.eliminar', function () {
    ...
    alertify.confirm(popUp, function () {
        ...
        fetch('/administracion/subsegmento/eliminar/'+codigo, {
            method: 'get',
        })
