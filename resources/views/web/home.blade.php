    ...
    <div class="contenido">
        ...
        <div class="flex-tu-negocio">
            ...
            <div class="tu-negocio">
                <a href="/mini-sitio" class="tu-negocio-n neg-1">
                    <img src="{{ asset('/public/web/imagenes/i-pasteleria.svg') }}" alt="">
                    <p>Pastelería</p>
                </a>
    
                <a href="/mini-sitio" class="tu-negocio-n neg-2">
                    <img src="{{ asset('/public/web/imagenes/i-citaliana.svg') }}" alt="">
                    <p>Comida Italiana</p>
                </a>
    
                <a href="/mini-sitio" class="tu-negocio-n neg-3">
                    <img src="{{ asset('/public/web/imagenes/i-crapida.svg') }}" alt="">
                    <p>Comida Rápida</p>
                </a>
    
                <a href="/mini-sitio" class="tu-negocio-n neg-4">
                    <img src="{{ asset('/public/web/imagenes/i-cafeteria.svg') }}" alt="">
                    <p>Cafetería</p>
                </a>
    
                <a href="/mini-sitio" class="tu-negocio-n neg-5">
                    <img src="{{ asset('/public/web/imagenes/i-salimentacion.svg') }}" alt="">
        ...
        <section class="conocenos mostrar-1920">
            ...
            <div class="concenos-img-txt">
                <div>
                    <div class="img"><img src="{{ asset('/public/web/imagenes/img-circulo2.svg') }}" alt=""></div>
                </div>
                <div>
