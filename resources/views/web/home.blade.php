        ...
        <div class="flexslider-seccion">
            <ul class="slides">
                ...
                <li style=" z-index:0; opacity: 1;" class="li-slider">
                    <img class="ocultar-movil" src="{{ asset('/web/imagenes/portada-home-escritorio.svg') }}" alt="">
                    <img class="ocultar-escritorio" src="{{ asset('/web/imagenes/portada-home-movil.svg') }}" alt="">
                </li>
