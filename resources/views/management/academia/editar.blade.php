                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="form-floating my-3">
                            <input type="text" name="titulo" class="form-control" id="titulo" value="{{ $academia->aca_titulo}}"
                                required>
                        </div>
                        <label for="titulo">Título 2</label>
                        <div class="form-floating my-3">
                            <input type="text" name="titulo2" class="form-control" id="titulo2" value="{{ $academia->aca_titulo2}}"
                                required>
                        </div>
                                ...
                                <div class="row mb-3">
                                    <div class="form-floating my-3">
                                        <select name="estado" id="estado" class="tipo-seleccion">
                                            ...
                                            <option {{ $academia->aca_estado == 0 ? 'selected' : false }} value="0">Inactivo</option>
                                        </select>
                                    </div>
                                </div>
